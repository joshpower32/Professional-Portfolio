document.addEventListener('DOMContentLoaded', () => {
    ...
    const projects = [
        ...
        { title: "Joe's Photography", desc: "A photography portfolio website with a Pexels API-powered search gallery, full-screen lightbox viewer, and dedicated pages for About, Gallery, Hire, and Contact. Built by Joshua Power.", link: "https://joshpower32.github.io/Joes-Photography-Framework/" },
        ...
        { title: "Cube World Recreation", desc: "A browser recreation of the 2005 Radica Cube World toy — drag colorful LCD cubes together and watch stick-figure residents peek, wave, and visit each other. Single-file vanilla JS and Canvas, no dependencies. Built by Joshua Power.", link: "https://joshpower32.github.io/Cube-World-Recreation/" },
